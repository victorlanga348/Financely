        ...
        <div className="min-h-screen bg-slate-950 text-slate-50 flex overflow-hidden">
            ...
            <main className="flex-1 flex flex-col relative overflow-y-auto overflow-x-hidden custom-scrollbar">
                ...
                <header className="p-4 md:p-6 lg:p-8 flex items-center justify-between z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs md:text-sm text-slate-400">Gerencie todos os seus ganhos.</p>
                        </div>
                    </div>
                ...
                <section className="px-4 md:px-8 pb-8 space-y-4 md:space-y-6 z-10">
                    <div className="glass-card p-5 md:p-6 rounded-[2rem] border-l-8 border-l-emerald-500 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                        <div>
                            <p className="text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-wider mb-1">Total Recebido (Mês)</p>
                            <h3 className="text-2xl md:text-4xl font-black text-white">{formatCurrency(totalIncome)}</h3>
                        </div>
                    </div>
